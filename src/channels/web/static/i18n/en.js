...
I18n.register('en', {
  ...
  'users.tokenPromptTitle': 'Create token for',
  'users.tokenNamePlaceholder': 'Token name',
  'users.tokenNameRequired': 'Token name is required',
  ...
  'users.failedTokenCreate': 'Failed to create token',
  'users.columns.id': 'ID',

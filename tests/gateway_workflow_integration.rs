...
mod tests {
    ...
    async fn routines_api_surfaces_unverified_status_for_new_routine() {
        ...
        disabled_routine.name = "wf-disabled-test".to_string();
        ...
        assert_eq!(listed["status"].as_str(), Some("active"));
        assert_eq!(listed["verification_status"].as_str(), Some("verified"));
        ...
        assert_eq!(summary["unverified"].as_u64(), Some(0));
        ...
        assert_eq!(detail["verification_status"].as_str(), Some("verified"));
